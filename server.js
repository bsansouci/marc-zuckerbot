...
function startBot(api, chats, lists, users, anonymousUsers) {
	...
	var allCommands = {
		'default': [addScore, spank, hashtag, subtractScore,score, ping, pickup, xkcdSearch, arbitraryLists, slap, hug, topScore, sendStickerBigSmall, reminders, setTimezone, sendPrivate, ignore, staticText, salute, weekendText, sexxiBatman, bees, albert, ericGame, sendSplit, sendBirthday],
		'in-game': [pipeToEric],
		'ignored': [ignore]
	};
